...
channels = fieldnames(PSD_Spect_Struct_actnorm_faNmiss.(stimFields{1})(1));
...
for sIdx = 1:numel(stimFields)
    ...
    for cIdx = 1:numel(channels)
        ...
        for bIdx = 1:length(bands)
            ...
            % Bootstrap Active
            [meanA, ciA, freqA] = bootstrap_psd(PSD_Spect_Struct_actnorm_faNmiss, stim, chan, band, nBoot);
