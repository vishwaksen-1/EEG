function all_data = t_segmentAllEEG(folder)
% t_segment_all_eeg - just like segment_all_eeg with an extension to give
% behavioural info
%   Segments and processes all EEG data files in a given folder.
...
addpath 'E:\PERRAND_EEG\eeg New Latest\Utils'
...
for sub = 1:numSubjects
    ...
    db_act = t_segmentEEGData(sub, setno, T_data_cleaned, experimentType);
