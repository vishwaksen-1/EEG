%==========================================================================
%                       EEG DATA VISUALIZATION TOOL - without Markers
%==========================================================================
...
function eegDataVisualizer()
    ...
    if strcmp(file_choice, 'Raw CSV File')
        [eeg_data, channel_labels, fs, time_vector, data_info] = load_csv_data();
    else
        [eeg_data, channel_labels, fs, time_vector, data_info] = load_mat_data();
    end
    ...
    launch_eeg_viewer(eeg_data, channel_labels, fs, time_vector, data_info);
...
function [eeg_data, channel_labels, fs, time_vector, data_info] = load_csv_data()
    ...
    try
        ...
        % Extract EEG data (exactly like ann_cleaning_trial.m)
...
function [eeg_data, channel_labels, fs, time_vector, data_info] = load_mat_data()
...
function launch_eeg_viewer(eeg_data, channel_labels, fs, time_vector, data_info)
    ...
    uicontrol('Parent', info_panel, 'Style', 'pushbutton', 'String', '>>', ...
        'Position', [570, 30, 40, 25], ...
        'Callback', @(src,evt) scroll_data_callback(window_samples), ...
        'TooltipString', 'Jump forward by full window');
